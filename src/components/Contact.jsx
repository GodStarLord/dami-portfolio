...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:damilola.onadeinde@gmail.com?subject=${encodeURIComponent(formData.subject || "Contact Form Submission")}&body=${encodeURIComponent(`Name: ${formData.name}\n\nMessage: ${formData.message}`)}`;
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">damilola.onadeinde@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Remote (GMT+1)</p>
                  </div>
                </div>
              </div>
            </div>
