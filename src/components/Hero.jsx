...
export default function Hero() {
  const words = [
    ...
    "Kubernetes Expert & Infrastructure Architect",
    "Automation Enthusiast & CI/CD Specialist",
    "Cloud-Native Solutions Developer",
  ];
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Cloud Infrastructure Architect 🚀 | DevOps Automation Specialist 🔧 | Building scalable systems and automating the future ☁️✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/dammyboss"
                ...
                {/* Contact Button */}
                <a
                  href="https://my.visualcv.com/dami-resume1"
                  target="_blank"
              ...
              <div className="hidden lg:block absolute left-[5.5rem] top-[2.3rem] animate-float-slow">
                <div className="px-4 py-2 rounded-lg bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 text-purple-400">
                  <i className="fas fa-wand-magic-sparkles"></i>&nbsp;&nbsp;DevOps
                  Magic
                </div>
              </div>
